...
exports.ChecksumsPatchGenerator = void 0;
...
class ChecksumsPatchGenerator extends PatchGenerator_base_1.AbsPatchGenerator {
    constructor() {
        super({ images: [''] });
    }
    /**
     ...
     */
    getStyle() {
        return Translations.map(trans => (0, PatchGenerator_base_1.css) `
...
//# sourceMappingURL=PatchGenerator.checksums.js.map