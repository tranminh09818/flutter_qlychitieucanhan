...
- (fix [#479](https://github.com/shalldie/vscode-background/issues/479)) docs: updated localization for Japanese by @shim4stat in [#483](https://github.com/shalldie/vscode-background/pull/483)
...
- fix(l10n): :bug: 修复插件提示在linux下不显示为中文的问题 (fix [#485](https://github.com/shalldie/vscode-background/issues/485)) by @hbcraft in [#486](https://github.com/shalldie/vscode-background/pull/486)
...
<img width="380" src="https://github.com/shalldie/vscode-background/raw/HEAD/images/containers.png">
...
6. More content can be found in [README.md](https://github.com/shalldie/vscode-background/blob/HEAD/README.md)，[Migration from v1](https://github.com/shalldie/vscode-background/blob/HEAD/docs/migration-from-v1.md)。
...
5. 添加了多语言（l10n）支持。
6. 更多内容可见 [README.md](https://github.com/shalldie/vscode-background/blob/HEAD/README.md)，[从 v1 迁移](https://github.com/shalldie/vscode-background/blob/HEAD/docs/migration-from-v1.md)。

## ver1.2.16 (2024/10/09)

    [#468](https://github.com/shalldie/vscode-background/issues/468), [#458](https://github.com/shalldie/vscode-background/issues/458)
    add statusbar to show all commands.
    添加状态栏按钮，用于快速展示所有命令。

## ver1.2.15 (2024/10/06)

    merge [#466](https://github.com/shalldie/vscode-background/issues/466)
