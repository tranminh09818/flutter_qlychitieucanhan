...
**English** | [中文](https://github.com/shalldie/vscode-background/blob/HEAD/README.zh-CN.md) | [日本語](https://github.com/shalldie/vscode-background/blob/HEAD/README.ja-JP.md)
...
![logo](https://github.com/shalldie/vscode-background/raw/HEAD/images/logo.png)
...
<img width="760" src="https://github.com/shalldie/vscode-background/raw/HEAD/images/section.png">

`fullscreen`

<img width="760" src="https://github.com/shalldie/vscode-background/raw/HEAD/images/fullscreen.png">
...
<img width="760" src="https://github.com/shalldie/vscode-background/raw/HEAD/images/containers.png">
...
<img width="660" src="https://github.com/shalldie/vscode-background/raw/HEAD/images/commands.png">

## Common Issues

> **This extension works by editting the vscode's js file.**

Please refer to the [Common Issues](https://github.com/shalldie/vscode-background/blob/HEAD/docs/common-issues.md) if you met some problems.

## Uninstall

Please refer to [Common Issues#how-to-uninstall](https://github.com/shalldie/vscode-background/blob/HEAD/docs/common-issues.md#how-to-uninstall).
...
Refer to [Contributing Guide](https://github.com/shalldie/vscode-background/blob/HEAD/docs/contributing.md).
...
The configuration of v1 is outdated and currently maintains a certain level of compatibility. Please refer to [migration-from-v1.md](https://github.com/shalldie/vscode-background/blob/HEAD/docs/migration-from-v1.md) for migration.
